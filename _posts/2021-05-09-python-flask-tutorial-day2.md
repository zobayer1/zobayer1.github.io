...
**[`setup.cfg`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/setup.cfg):**
...
**[`setup.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/setup.py):**
...
**[`tox.ini`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/tox.ini):**
...
**[`myapi/commons/helpers/metadata.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/myapi/commons/helpers/metadata.py):**
...
**[`myapi/endpoints/v1/health.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/myapi/endpoints/v1/health.py):**
...
**[`myapi/config.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/myapi/config.py):**
...
**[`myapi/app.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/myapi/app.py):**
...
**[`myapi/manage.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/myapi/manage.py):**
...
Start with the updated **[`tests/conftest.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/tests/conftest.py)**:
...
The health-check test carries over from part 1 unchanged; the endpoint didn't move, so **[`tests/test_health/test_status.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/tests/test_health/test_status.py)** still hits `/myapi/v1/health/status`:
...
A new test for the CLI command goes in **[`tests/test_cli.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/tests/test_cli.py)**:
...
**[`tests/test_config.py`](https://github.com/zobayer1/flask-restful-tutorial/blob/v0.2.0/tests/test_config.py):**
